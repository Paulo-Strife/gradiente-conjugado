...
void update_x_r(
    ...
    for (; i <= n - 4; i += 4) {
        ...
        x[i + 1] = x[i + 1] + alpha * p[i + 1];
        r[i + 1] = r[i + 1] - alpha * Ap[i + 1];

        x[i + 2] = x[i + 2] + alpha * p[i + 2];
        r[i + 2] = r[i + 2] - alpha * Ap[i + 2];

        x[i + 3] = x[i + 3] + alpha * p[i + 3];
        r[i + 3] = r[i + 3] - alpha * Ap[i + 3];
    }
