...
void multiplicacao_matrizes(const bandaMatriz * restrict A, const double * restrict x, double * restrict y) {
    int n = A->n;
    int mb = A->meia_banda;
...
double produto(const double * restrict a, const double * restrict b, int n) {
    double sum = 0.0;
