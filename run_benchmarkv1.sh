...
mkdir -p resultadosv1

SRC_BASELINE="conjugated_method.c"
SRC_V1="conjugated_methodv1.c"
...
gcc $SRC_V1 -o $BIN_V1 $FLAGS -lm

if [ $? -ne 0 ]; then
    echo "Erro ao compilar matriz_v1."
    exit 1
fi
...
echo "versao,N,banda,rep,tempo_s,memoria_kb,cycles,instructions,cache_references,cache_misses,branches,branch_misses" > resultados/benchmark_matriz.csv
...
for versao in baseline matriz_v1
do
...
echo "Arquivo gerado: resultados/benchmark_matriz.csv"